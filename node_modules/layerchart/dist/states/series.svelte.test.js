...
describe('SeriesState', () => {
    ...
    describe('stacking', () => {
        it('should detect stack layout', () => {
            const state = createSeriesState(series, {
                layout: 'stack',
                data: wideData,
                keyBy: 'date',
            });
        ...
        describe('with separate data per series', () => {
            ...
            it('should compute stack from aligned separate data', () => {
                ...
                const appleVal = state.getStackValue('apples', { date: '2024-01', value: 100 });
                const bananaVal = state.getStackValue('bananas', { date: '2024-01', value: 80 });

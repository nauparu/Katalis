...
function getBrushElements(container) {
    return {
        context: container.querySelector('.lc-brush-context'),
        range: container.querySelector('.lc-brush-range'),
...
describe('BrushContext', () => {
    ...
    describe('programmatic control', () => {
        ...
        it('should compute correct pixel width for brush.move()', async () => {
            ...
            expect(range).not.toBeNull();
            const brushContext = container.querySelector('.lc-brush-context');
    ...
    describe('zoomOnBrush with onBrushEnd', () => {
        it('should pass brush domain values to onBrushEnd before resetting', async () => {
            ...
            brushEl.dispatchEvent(new PointerEvent('pointerdown', { clientX: startX, clientY: y, bubbles: true }));
            brushEl.dispatchEvent(new PointerEvent('pointermove', { clientX: endX, clientY: y, bubbles: true }));
            brushEl.dispatchEvent(new PointerEvent('pointerup', { clientX: endX, clientY: y, bubbles: true }));
            await tick();

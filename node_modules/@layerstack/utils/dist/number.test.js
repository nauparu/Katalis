...
describe('formatNumber()', () => {
    ...
    describe('integer', () => {
        ...
        it('formats number with integer fr', () => {
            const actual = formatNumberWithLocale(createLocaleSettings({ locale: 'fr' }), 1234.5678, 'integer');
            expect(actual).equal('1 235');
        });
    });
    describe('decimal', () => {
    ...
    describe('currency', () => {
        ...
        it('formats number with currency EUR with right local', () => {
            const actual = formatNumberWithLocale(createLocaleSettings({ locale: 'fr' }), 1234.5678, 'currency', {
                currency: 'EUR',
            });
            expect(actual).equal('1 234,57 €');
        });

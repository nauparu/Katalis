...
import { generateTimeSeriesData, generateMultiSeriesData, generateSeparateSeriesData, } from '../../bench/generateData.js';
afterEach(() => {
    cleanup();
});
// ── Data size scaling ────────────────────────────────────────────────
...
describe('LineChart mount — series count', () => {
    ...
    const makeSeries = (keys) => keys.map((key) => ({ key, color: 'currentColor' }));
    bench('1 series', () => {
        cleanup();

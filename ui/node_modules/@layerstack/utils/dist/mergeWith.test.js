...
describe('mergeWith', () => {
    it('uses customizer result when not undefined', () => {
        ...
        const result = mergeWith(target, source, (tgtVal, srcVal) => {
    ...
    it('customizer can replace arrays entirely', () => {
        ...
        const result = mergeWith(target, source, (_, srcVal) => {
    ...
    it('provides correct arguments to customizer', () => {
        ...
        const calls = [];
        mergeWith(target, source, (tgtVal, srcVal, key) => {
    ...
    it('supports multiple sources with customizer', () => {
        const result = mergeWith({}, { a: 'one', b: 'two' }, { b: 'THREE', c: 'four' }, (tgt, src) => (tgt ? `${tgt} ${src}` : undefined));
...
describe('defaultsDeep', () => {
    ...
    it('preserves existing values at all levels', () => {
        const result = defaultsDeep({ level1: { level2: { existing: 'keep' } } }, { level1: { level2: { existing: 'replace', added: 'new' }, other: 'value' } });
        expect(result).toEqual({
